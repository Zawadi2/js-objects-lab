...
console.log("game.party array", game.party)
...
*/
// Pikachu (Electric type, power)
// Charmander (Fire type, HP)
// Squirtle (Water type, Defense)
...
*/
let starterIndex = game.party.findIndex(pokemon => pokemon.name === "Bulbasaur");
if (starterIndex !== -1) {
  game.party.splice(starterIndex, 1, { name: "Ivysaur", type: "Grass" });
}
/*
Exercise 8
